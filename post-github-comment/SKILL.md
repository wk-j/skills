...
7. **Edit existing comments** — When updating a previously posted comment, ALWAYS use `gh api -X PATCH` to edit in place. NEVER delete and re-create comments. **IMPORTANT: Only edit comments that were generated by AI** (contain the `🤖 Comment generated by AI` footer). NEVER edit comments written by users.
